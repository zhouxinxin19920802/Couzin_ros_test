...
class Agent:
    def __init__(self, general_actor,genearl_critic, actor_dims, critic_dims, n_actions,
    ...
    def learn(self, memory, agent_list):
        ...
        # logging.info("critic_loss:{},{}".format(self.agent_name,critic_loss))
